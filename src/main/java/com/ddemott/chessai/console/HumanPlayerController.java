...
public class HumanPlayerController implements PlayerController {
	...
	public Move selectMove(GameEngine gameEngine) {
		while (true) {
			...
			// TODO: Add command handling for help, history, undo, redo, save, export, load,
			// difficulty, captured, suggest, hint
			...
			// Use MoveHistory.addMove to create a move object for preview (not actually add
			// to history yet)
