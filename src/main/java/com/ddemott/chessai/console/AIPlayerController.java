    ...
    public Move selectMove(GameEngine gameEngine) {
        ...
        if (aiMove != null) {
            ...
            if (aiPositions.length == 2) {
                ...
                Move move = new Move(aiPositions[0], aiPositions[1], movingPiece, capturedPiece, "", moveNumber, playerColor, false, false, false, false, null);
                move.setScore(score);
                return move;
            }
        }
