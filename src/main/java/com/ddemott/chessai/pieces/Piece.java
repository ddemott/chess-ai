...
public abstract class Piece implements IPiece {
    ...
    // We can remove this later, but it helps avoid compilation errors in tests immediately
    ...
    public void setPosition(String position) {
        this.position = position;
        // setHasMoved(true) should probably be called by the board when actually moving, 
        // but the original code had it here. I'll keep the logic but move the assignment.
    }
