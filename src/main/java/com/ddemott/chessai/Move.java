...
/**
 * Represents a chess move with all necessary information for history tracking
 * and notation.
 */
public class Move {
	private int score = 0;
	 ...
	 */
	public static Move createSimpleMove(String from, String to, IPiece movingPiece, IPiece capturedPiece,
			int moveNumber, String playerColor) {
		return new Move(from, to, movingPiece, capturedPiece, "", moveNumber, playerColor, false, false, false, false,
				null);
	}
}