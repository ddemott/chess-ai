...
public class Board {
    ...
    // Deprecated: Moving specific print logic to ConsoleDisplay
    // Kept empty to satisfy existing calls until full cleanup
    public void printBoard() {
        // System.out.println(getBoardRepresentation());
    }
    ...
    private String getPieceSymbol(IPiece piece) {
        ...
        return piece.getSide() == Side.WHITE ? String.valueOf(symbol) : String.valueOf(Character.toLowerCase(symbol));
    }
    ...
    public String findKingPosition(String kingColor) {
        return findKingPosition(kingColor.equalsIgnoreCase("White") ? Side.WHITE : Side.BLACK);
    }
    ...
    // Deprecated print method - logic moved to ConsoleDisplay
