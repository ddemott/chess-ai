...
/**
 * Comprehensive test showing what happens with pawn promotion in different scenarios
 */
public class ComprehensivePawnPromotionBehaviorTest {
    ...
    private static void testDirectBoardMovement() {
        ...
        if (pieceOnE8 != null) {
            System.out.println("   Piece on e8: " + pieceOnE8.getClass().getSimpleName() + " (" + pieceOnE8.getColor() + ")");
