...
/**
 * Core chess rules and board logic tests: en passant, castling, promotion, stalemate, threefold repetition, fifty-move rule.
 */
public class BoardCoreRulesTest {
    ...
    void testEnPassantCapture() {
        try {
            ...
            System.out.println("En passant target after d7-d5: " + engine.getGameState().getBoard().getEnPassantTarget());
    ...
    void testCastlingKingSideAndQueenSide() {
        com.ddemott.chessai.engine.GameEngine engine = new com.ddemott.chessai.engine.GameEngine(1);
        engine.movePiece("e2", "e4"); engine.movePiece("e7", "e5");
        engine.movePiece("g1", "f3"); engine.movePiece("b8", "c6");
        engine.movePiece("f1", "e2"); engine.movePiece("g8", "f6");
    ...
    void testPawnPromotion() {
        ...
        engine.movePiece("a2", "a4"); engine.movePiece("h7", "h6");
        System.out.println(engine.getBoardRepresentation());
        engine.movePiece("a4", "a5"); engine.movePiece("h6", "h5");
        System.out.println(engine.getBoardRepresentation());
        engine.movePiece("a5", "a6"); engine.movePiece("h5", "h4");
        System.out.println(engine.getBoardRepresentation());
        engine.movePiece("a6", "a7"); engine.movePiece("h4", "h3");
        System.out.println(engine.getBoardRepresentation());
    ...
    void testStalemateDetection() {
        ...
        clearBoard(engine);
        // Place pieces for stalemate: Black king on h8, White king on f7, White queen on g6
    ...
    void testCastlingEdgeCases() {
        ...
        engine.movePiece("e2", "e4"); engine.movePiece("e7", "e5");
        engine.movePiece("e1", "e2"); engine.movePiece("d7", "d6");
        engine.movePiece("e2", "e1"); engine.movePiece("d6", "d5");
        ...
        engine = new GameEngine(1);
        engine.movePiece("a2", "a4"); engine.movePiece("h7", "h5");
        engine.movePiece("a1", "a2"); engine.movePiece("h8", "h6");
        engine.movePiece("a2", "a1"); engine.movePiece("h6", "h8");
    ...
    void testEnPassantEdgeCases() {
        ...
        engine.movePiece("e2", "e4"); engine.movePiece("a7", "a6");
        engine.movePiece("e4", "e5"); engine.movePiece("d7", "d5");
        ...
        for (String sq : allSquares) {
            ...
            if (piece != null && !(piece instanceof King)) {
                if (piece instanceof Bishop) {
                    if (piece.getColor().equals("White")) whiteBishops++;
                    else blackBishops++;
                } else if (piece instanceof Knight) {
                    if (piece.getColor().equals("White")) whiteKnights++;
                    else blackKnights++;
                } else {
                    otherPieces++;
                }
    ...
    // Helper to parse board representation and get the piece at a given square (e.g., "e4")
