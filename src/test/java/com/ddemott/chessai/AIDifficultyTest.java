...
public class AIDifficultyTest {
    ...
    private static boolean testDifficultyEnumValues() {
        try {
            ...
            return difficulties.length == 6 &&
                   difficulties[0] == AIDifficulty.BEGINNER &&
    ...
    private static boolean testDepthMapping() {
        try {
            // Test depth mappings
            return AIDifficulty.BEGINNER.getDepth() == 1 &&
                   AIDifficulty.EASY.getDepth() == 2 &&
                   AIDifficulty.INTERMEDIATE.getDepth() == 3 &&
                   AIDifficulty.ADVANCED.getDepth() == 4 &&
                   AIDifficulty.EXPERT.getDepth() == 5 &&
    ...
    private static boolean testGameEngineConstructor() {
        try {
            ...
            return difficulty1 == AIDifficulty.INTERMEDIATE &&
                   difficulty2.getDepth() == 3;
        } catch (Exception e) {
    ...
    private static boolean testDifficultyStrings() {
        try {
            ...
            return beginnerString.contains("Beginner") &&
                   beginnerString.contains("Depth 1") &&
                   allDifficulties.contains("Available AI Difficulty Levels") &&
                   allDifficulties.contains("Beginner") &&
                   allDifficulties.contains("Master");
        } catch (Exception e) {
