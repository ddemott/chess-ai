...
public class CastlingTest {
    ...
    private static boolean testKingsideCastling() {
        try {
            ...
            boolean correctKingPosition = kingAtG1 != null && kingAtG1 instanceof King && kingAtG1.getColor().equals("White");
            boolean correctRookPosition = rookAtF1 != null && rookAtF1 instanceof Rook && rookAtF1.getColor().equals("White");
    ...
    private static boolean testQueensideCastling() {
        try {
            ...
            boolean correctKingPosition = kingAtC1 != null && kingAtC1 instanceof King && kingAtC1.getColor().equals("White");
            boolean correctRookPosition = rookAtD1 != null && rookAtD1 instanceof Rook && rookAtD1.getColor().equals("White");
            boolean kingMoved = nothingAtE1 == null;
    ...
    private static boolean testBothColorsCanCastle() {
        try {
            ...
            boolean whiteKingCorrect = whiteKingAtG1 != null && whiteKingAtG1 instanceof King && whiteKingAtG1.getColor().equals("White");
            boolean blackKingCorrect = blackKingAtG8 != null && blackKingAtG8 instanceof King && blackKingAtG8.getColor().equals("Black");
