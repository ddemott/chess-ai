...
public class BoardIsKingInCheckTest {
    ...
    public void testKingInCheckByKnight() {
        Board board = new Board();
        // Remove pieces blocking the knight
        board.setPieceAt("f3", null);
        board.setPieceAt("g2", null);
        // Place black knight on g3
    board.setPieceAt("g3", new Knight("Black", "g3"));
        assertTrue(board.isKingInCheck("White"), "White king should be in check from black knight on g3");
    }
