...
public class SpecialMovesTest {
    ...
    void testPawnPromotion() {
        ...
        // Verify promotion
        assertTrue(engine.getGameState().getBoard().getPieceAt("e8") instanceof Queen, "Pawn should be promoted to queen");
        assertEquals("White", engine.getGameState().getBoard().getPieceAt("e8").getColor(), "Promoted piece should be white");
    }
    ...
    void testPawnPromotionToKnight() {
        try {
            ...
            // Verify promotion
            assertTrue(engine.getGameState().getBoard().getPieceAt("e8") instanceof Knight, "Pawn should be promoted to knight");
            assertEquals("White", engine.getGameState().getBoard().getPieceAt("e8").getColor(), "Promoted piece should be white");
        } catch (Exception e) {
