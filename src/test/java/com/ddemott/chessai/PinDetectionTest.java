...
public class PinDetectionTest {
	...
	void testHorizontalPin() {
		...
		// Set up a horizontal pin: White king on e1, White queen on e2, Black rook on
		// e8
	...
	void testMultiplePins() {
		...
		// Test bishop movement - should not be able to move at all (bishops can't move
		// horizontally)
	...
	void testPinEdgeCases() {
		...
		// Edge case 2: Potential pin that isn't actually a pin (piece can capture
		// attacker)
