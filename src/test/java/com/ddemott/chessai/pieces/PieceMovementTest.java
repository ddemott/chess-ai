...
public class PieceMovementTest {
    ...
    void testPawnDoubleMoveAndCapture() {
        ...
        // Test double move
        assertTrue(whitePawn.isValidMove("e4", board), "White pawn should be able to move two squares from starting position");
        ...
        assertFalse(whitePawn.isValidMove("e6", board), "Pawn should not be able to move two squares after initial move");
